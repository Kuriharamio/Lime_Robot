...
def generate_launch_description():
    ...
    navigation_dir = get_package_share_directory('navigation2_config')
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([cartographer_dir,'/launch','/cartographer_localization.launch.py'])
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([navigation_dir,'/launch','/robot_nav2.launch.py'])
        ),
